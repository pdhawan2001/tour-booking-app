...
if (bookBtn) {
  bookBtn.addEventListener('click', (e) => {
    ...
    const { tourId } = e.target.dataset; // data-tour-id, this id automatically gets converted into 'tourId' in JS // element.target is basically the button which was clicked, that is which triggered tthis event listner to be fired
    bookTour(tourId);
  });
}
