...
router.use(authController.protect); // it will only call the next middleware if authenticated as middleware run line by line, so puting it here one time for below routes
